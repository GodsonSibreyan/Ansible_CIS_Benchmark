...

{
   ...
   {
       echo "Set-AzureRmSqlServerThreatDetectionPolicy -ResourceGroupName $RG -ServerName $SS -NotificationRecipientsEmails "godsonsibreyan108@gmail.com""
    Set-AzureRmSqlServerThreatDetectionPolicy -ResourceGroupName $RG -ServerName $SS -NotificationRecipientsEmails "godsonsibreyan108@gmail.com"
